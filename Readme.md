...
####################################################################################################
##
##  Nexgen ACE Extension version 2N for IACEv12
##  [NexgenACEExt12_2N - For Nexgen 112N]
##
##  Version: 2
...
####################################################################################################
 ...
 3. Copy the NexgenACEExt12_2N.u file to the system folder of your UT
    server.

 4. If your server is using redirect upload the NexgenACEExt12_2N.u.uz file
    to the redirect server.

 5. Open your servers configuration file and add the following server package:

      ServerPackages=NexgenACEExt12_2N

    Also add the following server actor:

      ServerActors=NexgenACEExt12_2N.NexgenACEExt
...
####################################################################################################
 ...
 2. Delete NexgenACEExt12_x.u (where x is the previous version of the
    Plugin) from your servers system folder and upload NexgenACEExt12_2N.u
    to the same folder.

 3. If your server is using redirect you may wish to delete
    NexgenACEExt12_x.u.uz if it is no longer used by other servers.
    Also upload NexgenACEExt12_2N.u.uz to the redirect server.
...
- If you recompile or edit this plugin, please leave the credits part of the readme intact, as well
  ...
  version numbers are forbidden (e.g. NexgenACEExt12_3). Instead, add an unique suffix 
  (e.g. NexgenACEExt12_3_X).
